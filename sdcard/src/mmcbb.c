...
#define		CS_H()		digitalWrite(29,1)	/* Set MMC CS "high" */
#define 	CS_L()		digitalWrite(29,0)	/* Set MMC CS "low" */
#define 	CK_H()		digitalWrite(25,1)	/* Set MMC SCLK "high" */
#define		CK_L()		digitalWrite(25,0)	/* Set MMC SCLK "low" */
#define 	DI_H()		digitalWrite(24,1)	/* Set MMC DI "high" */
#define 	DI_L()		digitalWrite(24,0)	/* Set MMC DI "low" */
#define 	DO		digitalRead(23)		/* Test for MMC DO ('H':true, 'L':false) */
